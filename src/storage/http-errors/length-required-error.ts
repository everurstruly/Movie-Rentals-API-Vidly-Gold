...
class LengthRequiredError extends HttpError {
  constructor(
    ...
    super(message, 'LengthRequiredHttpError', statusCode, issues, cause, {
shouldExposeIssues: true 
});
  }
}

export const LengthRequiredErrorBuilder = () =>
  new HttpErrorResponseFormatter({
    ...
    useFormatting: (formatting, cause) => {
      ...
      throw new LengthRequiredError(message, issues, cause);
    },
  });
