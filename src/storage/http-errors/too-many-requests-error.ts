...
class TooManyRequestsError extends HttpError {
  constructor(
    ...
    super(message, 'TooManyRequestsHttpError', statusCode, issues, cause, {
shouldExposeIssues: true 
});
  }
}

export const TooManyRequestsErrorBuilder = () =>
  new HttpErrorResponseFormatter({
    ...
    useFormatting: (formatting, cause) => {
      ...
      throw new TooManyRequestsError(message, issues, cause);
    },
  });
