// import { seedContentRatingModel } from "../../database/seeders/content-rating-seeder";
// import { seedCustomerModel } from "../../database/seeders/customer-seeder";
// import { seedMovieModel } from "../../database/seeders/movie-seeder";
// import { seedRoleModel } from "../../database/seeders/role-seeder";
// import { seedUserModel } from "../../database/seeders/user-seeder";
// import { seedRentalModel } from "../../database/seeders/rental-seeder";
// import * as seedErrors from "./errors";
// import * as constants from "./constants";
// import * as seedUtils from "./utils";
// import * as objliteralUtils from "src/lib/utils/object-literal-utils";

// const cliQueryModelToSeederMapping = Object.freeze({
//   contentRating: seedContentRatingModel,
//   customer: seedCustomerModel,
//   movie: seedMovieModel,
//   user: seedUserModel,
//   role: seedRoleModel,
//   rental: seedRentalModel,
// });

// const availableSeederModels = objliteralUtils.objectKeys(
//   cliQueryModelToSeederMapping
// );

// export type CliSeederQueryOperations =
//   typeof constants.queryInputOperations[number];

// export type CliSeederQueryModelNames = typeof availableSeederModels;
